...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MaxMemorySettings) DeepCopyInto(out *MaxMemorySettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MaxMemorySettings.
func (in *MaxMemorySettings) DeepCopy() *MaxMemorySettings {
	if in == nil {
		return nil
	}
	out := new(MaxMemorySettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RedisSettings) DeepCopyInto(out *RedisSettings) {
	*out = *in
	...
	if in.PodDisruptionBudgetMinAvailable != nil {
		in, out := &in.PodDisruptionBudgetMinAvailable, &out.PodDisruptionBudgetMinAvailable
