...
// ValkeyFailover represents a Valkey failover
// +kubebuilder:printcolumn:name="NAME",type="string",JSONPath=".metadata.name"
// +kubebuilder:printcolumn:name="REDIS",type="integer",JSONPath=".spec.valkey.replicas"
// +kubebuilder:printcolumn:name="SENTINELS",type="integer",JSONPath=".spec.sentinel.replicas"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:singular=valkeyfailover,path=valkeyfailovers,shortName=rf,scope=Namespaced
type ValkeyFailover struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              ValkeyFailoverSpec   `json:"spec"`
	Status            ValkeyFailoverStatus `json:"status,omitempty"`
}

// ValkeyFailoverSpec represents a Valkey failover spec
type ValkeyFailoverSpec struct {
	Valkey         ValkeySettings     `json:"valkey,omitempty"`
...
// ValkeyCommandRename defines the specification of a "rename-command" configuration option
type ValkeyCommandRename struct {
	From string `json:"from,omitempty"`
	To   string `json:"to,omitempty"`
}

// ValkeySettings defines the specification of the valkey cluster
type ValkeySettings struct {
	...
	CustomCommandRenames          []ValkeyCommandRename             `json:"customCommandRenames,omitempty"`
	Command                       []string                          `json:"command,omitempty"`
	ShutdownConfigMap             string                            `json:"shutdownConfigMap,omitempty"`
	StartupConfigMap              string                            `json:"startupConfigMap,omitempty"`
	Storage                       ValkeyStorage                     `json:"storage,omitempty"`
...
// Exporter defines the specification for the valkey/sentinel exporter
...
// ValkeyStorage defines the structure used to store the Valkey Data
...
// ValkeyFailoverList represents a Valkey failover list
type ValkeyFailoverList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata"`

	Items []ValkeyFailover `json:"items"`
}

type ValkeyFailoverStatus struct {
