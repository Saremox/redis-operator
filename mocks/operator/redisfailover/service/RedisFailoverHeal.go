...
// EnsureRedisMaxMemory provides a mock function with given fields: rFailover, master, redises
func (_m *RedisFailoverHeal) EnsureRedisMaxMemory(rFailover *v1.RedisFailover, master string, redises []string) (service.MaxMemoryResult, error) {
	ret := _m.Called(rFailover, master, redises)

	var r0 service.MaxMemoryResult
	var r1 error
	if rf, ok := ret.Get(0).(func(*v1.RedisFailover, string, []string) (service.MaxMemoryResult, error)); ok {
		return rf(rFailover, master, redises)
	}
	if rf, ok := ret.Get(0).(func(*v1.RedisFailover, string, []string) service.MaxMemoryResult); ok {
		r0 = rf(rFailover, master, redises)
	} else {
		r0 = ret.Get(0).(service.MaxMemoryResult)
	}
